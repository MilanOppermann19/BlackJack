...
/*
 * Creates a dealer for the player to play against.
 */
class PlayerandDealer {
ArrayList<Card> hand;//arraylist to represent the dealer's hand
private int handvalue=0;//value of the dealer's hand (starting at 0)
private Card[] aHand;//private Card[] aHand is used to convert the dealer's hand to an array
private int AceCounter;//counts the number of aces in the dealer's hand

PlayerandDealer(Deck deck)
{
    hand = new ArrayList<>();
    aHand = new Card[]{};
    int AceCounter=0;
