...
public static void main(String[] args){
    ...
    while(cash>0){
        ...
        if(hasBlackJack(handvalue) && dealer.DealerBlackJack())//check if both the user and dealer have blackjack.
        {
            Push();
        }
        ...
        else if(dealer.DealerBlackJack())//check if the dealer has blackjack.
        {
        ...
        else
        {
            ...
            {
                int dealerhand = dealer.DealerTurn(deck);//takes the turn for the dealer.
                System.out.println("");
                System.out.println("Here is the dealer's hand:");
                dealer.DealerHand();
